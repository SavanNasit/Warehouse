...
public class ItemsVariationAdapter extends RecyclerView.Adapter<ItemsVariationAdapter.MyViewHolder> {
    private ItemsVariationAdapterListener listener;
    private Activity activity;
    private List<ItemList> itemDataList;

    public ItemsVariationAdapter(Activity activity, List<ItemList> itemDataList,
                                 ItemsVariationAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_product_item, parent, false);
    ...
    public interface ItemsVariationAdapterListener {
