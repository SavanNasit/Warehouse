package com.accrete.warehouse.domain;
...
//                CustomisedToast.error(DomainActivity.this, getString(R.string.invalid_domain), Toast.LENGTH_SHORT).show();
    ...
    private void getDomain() {
        ...
        task = getString(R.string.domain);
...
//                    CustomisedToast.error(DomainActivity.this, getString(R.string.invalid_domain), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call call, Throwable t) {
                progressBar.setVisibility(View.GONE);
                textViewNext.setEnabled(false);
               // CustomisedToast.error(DomainActivity.this, getString(R.string.error_domain), Toast.LENGTH_SHORT).show();
                Toast.makeText(DomainActivity.this, R.string.error_domain, Toast.LENGTH_SHORT).show();
                new Handler().postDelayed(new Runnable() {
