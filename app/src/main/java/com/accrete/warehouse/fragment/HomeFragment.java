                        ...
                        for (WarehouseList warehouseList : apiResponse.getData().getWarehouseList()) {
                            if (apiResponse.getData().getWarehouseList() != null) {
                                ...
                                if (apiResponse.getData().getWarehouseList().size() > 0 &&
                                    ...
                                    AppPreferences.setWarehouseDefaultName(getActivity(), AppUtils.WAREHOUSE_DEFAULT_NAME, apiResponse.getData().getWarehouseList().get(0).getName());
                                    AppPreferences.setWarehouseDefaultCheckId(getActivity(), AppUtils.WAREHOUSE_CHK_ID, apiResponse.getData().getWarehouseList().get(0).getChkid());
                                    AppPreferences.setWarehouseOrderCount(getActivity(), AppUtils.WAREHOUSE_ORDER_COUNT, apiResponse.getData().getWarehouseList().get(0).getOrderCount());
                                    AppPreferences.setWarehousePackageCount(getActivity(), AppUtils.WAREHOUSE_PACKAGE_COUNT, apiResponse.getData().getWarehouseList().get(0).getPackageCount());
                                    AppPreferences.setWarehouseGatepassCount(getActivity(), AppUtils.WAREHOUSE_GATEPASS_COUNT, apiResponse.getData().getWarehouseList().get(0).getGatepassCount());
                                    AppPreferences.setWarehouseConsignmentCount(getActivity(), AppUtils.WAREHOUSE_CONSIGNMENT_COUNT, apiResponse.getData().getWarehouseList().get(0).getConsignmentCount());
                                    AppPreferences.setWarehouseReceiveConsignmentCount(getActivity(), AppUtils.WAREHOUSE_RECEIVE_CONSIGNMENT, apiResponse.getData().getWarehouseList().get(0).getReceiveConsignmentCount());
                                }
                            }
                        }
