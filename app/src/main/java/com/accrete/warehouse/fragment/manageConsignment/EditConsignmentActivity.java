...
public class EditConsignmentActivity extends AppCompatActivity implements View.OnClickListener, PassDateToCounsellor, CompoundButton.OnCheckedChangeListener, ReceiveConsignmentItemsAdapter.ReceiveConsignmentItemsAdapterListener, VendorsAdapter.VendorsAdapterListener, AuthorizedByUserAdapter.AuthorizedByUserAdapterListener, ItemsVariationAdapter.ItemsVariationAdapterListener {
    ...
    public EditConsignmentActivity() {
    }
    ...
    private void findViews(){
        ...
        toolbar.setTitle(getString(R.string.edit_consignment));
                ...
                if (getPostData()) {
                    ...
                    if (!status.equals(getString(R.string.not_connected_to_internet))) {
                        if (editConsignmentEdittextVendor.getText().toString() == null
                            ...
                            Toast.makeText(EditConsignmentActivity.this, "Please add vendor", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(EditConsignmentActivity.this, "Please enter invoice number", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(EditConsignmentActivity.this, "Please add at least one item", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(EditConsignmentActivity.this, getString(R.string.no_internet_try_later), Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public boolean getPostData() {
        if (editConsignmentTextReceiveDate.getText().toString().trim().length() == 0) {
            Toast.makeText(EditConsignmentActivity.this, "Please select receive date.", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        vendorSearchAutoCompleteTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (vendorSearchAutoCompleteTextView.isPerformingCompletion()) {
                    ...
                    status = NetworkUtil.getConnectivityStatusString(EditConsignmentActivity.this);
                    if (!status.equals(getString(R.string.not_connected_to_internet))) {
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    if (apiResponse.getSuccess()) {
                        ...
                        openDialogAddEditItems(EditConsignmentActivity.this, "add", 0, consignmentItem);
