...
import com.accrete.warehouse.fragment.creategatepass.GatepassFragment;
import com.accrete.warehouse.fragment.creategatepass.PackageSelectionFragment;
...
public class CreateGatepassActivity extends AppCompatActivity {
  ...
  /*      Bundle bundle = new Bundle();
    ...
    public void onBackPressed() {
        ...
        if (f instanceof CreatePassMainTabFragment) {
            ((CreatePassMainTabFragment) f).onBackPressed();
        }}
}
