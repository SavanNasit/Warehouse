...
public class QuotationItemsAdapter extends RecyclerView.Adapter<QuotationItemsAdapter.MyViewHolder> {
    private Activity activity;
    private List<ItemData> itemDataList;
    private QuotationItemsAdapterListener listener;

    public QuotationItemsAdapter(Activity activity, List<ItemData> itemDataList,
                                 QuotationItemsAdapterListener listener) {
    ...
    public interface QuotationItemsAdapterListener {
