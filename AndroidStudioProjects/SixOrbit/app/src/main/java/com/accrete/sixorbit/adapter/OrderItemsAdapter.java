...
public class OrderItemsAdapter extends RecyclerView.Adapter<OrderItemsAdapter.MyViewHolder> {
    ...
    public OrderItemsAdapter(Activity activity, List<ItemData> itemDataList,
                             OrderItemsAdapterListener listener, String flagDealerPrice) {
        this.activity = activity;
        this.itemDataList = itemDataList;
        this.listener = listener;
        this.flagDealerPrice = flagDealerPrice;
    }
    ...
    private void applyClickEvents(MyViewHolder holder, final int position) {
        ...
        if (itemData.getSelectedTaxName() == null ||
                itemData.getSelectedTaxName().isEmpty() ||
                itemData.getSelectedTaxName().equals("null") || itemData.getSelectedTaxName().equals("Select")) {
            holder.taxTextView.setText("No tax");
        } else {
            if (itemData.getSelectedTaxName() != null) {
                holder.taxTextView.setText("Tax: " + itemData.getSelectedTaxName() + "");
        ...
        if (itemData.getStrDealerFlag() != null && itemData.getStrDealerFlag().equals("1")) {
            if (itemData.getDealerPriceSubtotal() != null && !itemData.getDealerPriceSubtotal().equals("-0.0")) {
                holder.subtotalTextView.setText("Subtotal: " + formatter.format(Double.parseDouble(itemData.getDealerPriceSubtotal())));
            } else {
                holder.subtotalTextView.setText("Subtotal: " + "0");
            }
        } else {
