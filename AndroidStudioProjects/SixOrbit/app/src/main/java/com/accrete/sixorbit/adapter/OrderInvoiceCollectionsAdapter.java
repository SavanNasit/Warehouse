...
/**
 * Created by {Anshul} on 11/6/18.
 */

public class OrderInvoiceCollectionsAdapter extends RecyclerView.Adapter<OrderInvoiceCollectionsAdapter.MyViewHolder> {
    private Activity activity;
    private List<CollectionData> collectionDataList;
    private MyCollectionsListener listener;
    private SimpleDateFormat simpleDateFormat;

    public OrderInvoiceCollectionsAdapter(Activity activity, List<CollectionData> collectionDataList,
