...
public class QuotationCustomersAdapter extends RecyclerView.Adapter<QuotationCustomersAdapter.MyViewHolder> {
    private QuotationCustomersAdapterListener listener;
    private Activity activity;
    private List<CustomerList> itemDataList;

    public QuotationCustomersAdapter(Activity activity, List<CustomerList> itemDataList,
                                     QuotationCustomersAdapterListener listener) {
    ...
    private void applyClickEvents(MyViewHolder holder, final int position) {
        final CustomerList objectItem = itemDataList.get(position);
        ...
        if (objectItem.getCustomerType() != null && objectItem.getCustomerType().toString().trim() != null
                && !objectItem.getCustomerType().toString().trim().isEmpty()) {
            holder.typeLayout.setVisibility(View.VISIBLE);
            holder.typeTextView.setText(objectItem.getCustomerType().toString().trim());
        } else {
    ...
    public interface QuotationCustomersAdapterListener {
