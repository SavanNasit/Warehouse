...
import com.accrete.sixorbit.adapter.ConvertedManageQuotationAdapter;
...
public class ConvertedManageFragment extends Fragment implements ConvertedManageQuotationAdapter.
        ConvertedManageQuotationAdapterListener, SwipeRefreshLayout.OnRefreshListener,
    ...
    private ConvertedManageQuotationAdapter quotationsAdapter;
    ...
    private String[] actionsArr = new String[]{"View Details", "Download Quotation",
            "Quotation History"};
    ...
    private void initializeView(View rootView) {
        ...
        quotationsAdapter = new ConvertedManageQuotationAdapter(getActivity(), quotationList, this);
    ...
    private void getQuotationsList(final String time, final String traversalValue) {
        ...
        Call<ApiResponse> call = apiService.getPendingQuotationList(version, key, task, userId, accessToken,
                time, traversalValue, "1", searchText);
