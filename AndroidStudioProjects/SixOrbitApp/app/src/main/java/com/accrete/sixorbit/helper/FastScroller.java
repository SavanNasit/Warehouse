...
import com.accrete.sixorbit.model.BubbleTextGetter;

import static android.support.v7.widget.RecyclerView.OnScrollListener;


/**
 * Created by poonam on 15/5/17.
 */
...
public class FastScroller extends LinearLayout {
    ...
    private void initialise(Context context) {
        ...
        handle = (Button) findViewById(R.id.fastscroller_handle);
    }
    ...
    private void setRecyclerViewPosition(float y) {
        ...
        try {
            if (recyclerView != null) {
                ...
                Log.d("targetItemCount", String.valueOf(itemCount));
                Log.d("targetPosition", String.valueOf(targetPos));
                if (handle != null && targetPos > 0) {
                    String bubbleText = ((BubbleTextGetter) recyclerView.getAdapter()).getTextToShowInBubble(targetPos);
                    Log.d("targetPosition", String.valueOf(targetPos));
                    handle.setText(bubbleText);
                }
            }
        }catch (Exception e){
            e.printStackTrace();
