...
public class VendorShippingAddressAdapter extends RecyclerView.Adapter<VendorShippingAddressAdapter.MyViewHolder> {
    public List<VendorShippingAddress> customerAddressList = new ArrayList<>();
    private Context mContext;

    public VendorShippingAddressAdapter(Context context, List<VendorShippingAddress> customerAddressList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        VendorShippingAddress address = customerAddressList.get(position);
