...
public class OrdersProductsInfoAdapter extends RecyclerView.Adapter<OrdersProductsInfoAdapter.MyViewHolder> {
    private Activity activity;
    private ArrayList<ItemData> itemDataList;

    public OrdersProductsInfoAdapter(Activity activity, ArrayList<ItemData> itemDataList) {
