...
import com.accrete.sixorbit.adapter.CustomerOrderAdapter;
...
public class CustomerOrderFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
        View.OnClickListener, PassDateToCounsellor, CustomerOrderAdapter.CustomerOrderAdapterListener {
    ...
    private void findViews(View view) {
        ...
        adapter = new CustomerOrderAdapter(getActivity(), orderArrayList, cuid, this);
    ...
    private void getOrdersList(final String time, final String traversalValue) {
        task = getString(R.string.customer_order_details);
        ...
        Call<ApiResponse> call = apiService.getCustomerOrders(version, key, task, userId, accessToken, cuid, time, traversalValue);
    ...
    public void onMessageRowClicked(int position, String orderId, String orderText) {
        ...
        navigateDetailScreen(orderId, orderText);
    }

    private void navigateDetailScreen(String orderId, String orderText) {
