...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder> {
    ...
    public AddressAdapter(Activity activity, List<AddressList> addressLists,
                          AddressItemClickListener listener, String addressType) {
    ...
    private void applyClickEvents(MyViewHolder holder, final int position) {
        ...
        //holder.radioButton.setText(addressText);
        holder.addressTextView.setText(addressText);
        //    holder.radioButton.setChecked(position == lastCheckedPosition);
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.currentAddressItemClick(position);
            }
        });
    ...
    public interface AddressItemClickListener {
        void currentAddressItemClick(int position);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView addressTextView, addressNameTextView, phoneTextView;
        ...
        public MyViewHolder(View view) {
            ...
            radioBtnImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    listener.currentAddressItemClick(getAdapterPosition());
                }
            });
