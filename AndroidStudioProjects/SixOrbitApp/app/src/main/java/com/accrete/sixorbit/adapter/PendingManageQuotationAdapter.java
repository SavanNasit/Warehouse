...
public class PendingManageQuotationAdapter extends RecyclerView.Adapter<PendingManageQuotationAdapter.MyViewHolder> {
    private Context context;
    private List<QuotationDatum> pendingList;
    private PendingManageQuotationAdapterListener listener;
    private SimpleDateFormat simpleDateFormat;

    public PendingManageQuotationAdapter(Context context, List<QuotationDatum> pendingList,
                                         PendingManageQuotationAdapterListener listener) {
    ...
    public interface PendingManageQuotationAdapterListener {
