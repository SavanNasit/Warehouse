...
public class VendorsConsignmentDetailsActivity extends AppCompatActivity {
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private String venid, consignmentId, consignmentTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(getString(R.string.consignment_id))) {
            consignmentId = getIntent().getStringExtra(getString(R.string.consignment_id));
        }
        if (getIntent().hasExtra(getString(R.string.consignment_id_text))) {
            consignmentTitle = getIntent().getStringExtra(getString(R.string.consignment_id_text));
        }
        ...
        setTitle(consignmentTitle);

        tabLayout.setTabMode(TabLayout.MODE_FIXED);

        //Set TabLayout with ViewPager
        setupViewPager(viewPager, venid, consignmentId);
    ...
    private void setupViewPager(ViewPager viewPager, String venid, String consignmentId) {
        Bundle bundle = new Bundle();
        bundle.putString(getString(R.string.venid), venid);
        bundle.putString(getString(R.string.consignment_id), consignmentId);
        ...
        adapter.addFragment(consignmentDetailsTabFragment, "Consignment Details");
        adapter.addFragment(inventoryTabFragment, "Inventory");
