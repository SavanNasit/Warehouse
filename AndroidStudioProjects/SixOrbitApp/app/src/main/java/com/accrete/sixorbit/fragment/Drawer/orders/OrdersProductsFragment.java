...
import com.accrete.sixorbit.adapter.OrdersProductsInfoAdapter;
 ...
 */
public class OrdersProductsFragment extends Fragment {

    private TextView textViewEmpty;
    private RecyclerView recyclerView;
    private LinearLayoutManager mLayoutManager;
    private OrdersProductsInfoAdapter mAdapter;
    private ArrayList<ItemData> dataArrayList = new ArrayList<>();

    public OrdersProductsFragment() {
    ...
    private void initializeView(View rootView) {
        ...
        mAdapter = new OrdersProductsInfoAdapter(getActivity(), dataArrayList);
