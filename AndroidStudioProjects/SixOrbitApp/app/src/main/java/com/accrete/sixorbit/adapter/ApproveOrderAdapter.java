...
public class ApproveOrderAdapter extends RecyclerView.Adapter<ApproveOrderAdapter.MyViewHolder> {
    ...
    private ApproveOrderListener listener;
    private SimpleDateFormat simpleDateFormat;

    public ApproveOrderAdapter(Activity activity, List<Order> orderList,
                               ApproveOrderListener listener) {
    ...
    private void applyClickEvents(MyViewHolder holder, final int position, final String orderId,
    ...
    public interface ApproveOrderListener {
