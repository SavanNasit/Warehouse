...
public class CreateOrderActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private String orderTemId, strCuid, strBaid, strSaid, strChkId, strCName, strCMobile, strCEmail, status, strMail, strSms, strAssignee,
            ...
            stringStartDate, strIsVid, strProductsImageUrl;
    ...
    private void updatePreCharges() {
        try {
            for (int i = 0; i < preChargesListArrayList.size(); i++) {
                ...
                if (chargesList.getEctid() != null && chargesList.getEctid().equals("2") &&
                    ...
                    if (chargesList.getEctid() != null && chargesList.getEctid().equals("2")) {
                        ...
                        chargesList.setDiscountValue(chargesList.getDiscountValue().toString());
                        chargesList.setDiscountAmountValue("" + chargesList.getDiscountValue().toString().trim());
                    } else {
                        ...
                        double nextValue = ((newValue * ParseDouble(chargesList.getDiscountValue().toString())) / 100);
            ...
            if (quotationPreChargesAdapter != null && preChargesListArrayList != null && preChargesListArrayList.size() > 0) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            orderItemsAdapter = new OrderItemsAdapter(CreateOrderActivity.this, itemDataArrayList, this,
                    strFlagDealerPrice);
            paymentModesAdapter = new PaymentModesAdapter(CreateOrderActivity.this, paymentAttributesList, this);
            ...
            RecyclerView.LayoutManager paymentModeLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
            ...
            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
            ...
            databaseHandler = new DatabaseHandler(CreateOrderActivity.this);
        ...
        assigneeNameArrayList.add(chatContacts);*/
            ...
            quotationChargesListAdapter = new QuotationChargesListAdapter(CreateOrderActivity.this, preChargesListArrayList,
                    taxListArrayList, "0", this);
            quotationChargesTwoListAdapter = new QuotationChargesTwoListAdapter(CreateOrderActivity.this, postChargesListArrayList, this);
            quotationThreeChargesDropDownAdapter = new QuotationThreeChargesDropDownAdapter(CreateOrderActivity.this,
                    chargesList3ArrayList, taxListArrayList, "0", this);

            //Charge List RecyclerView
            RecyclerView.LayoutManager mChargeListLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
            ...
            RecyclerView.LayoutManager mChargeListTwoLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
       ...
       /* RecyclerView.LayoutManager mChargeListThreeLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
        ...
        chargeListThreeRecyclerView.setNestedScrollingEnabled(false);*/
            ...
            ArrayAdapter<String> paymentTermsTypeArrayAdapter =
                    new ArrayAdapter<String>(CreateOrderActivity.this, R.layout.simple_spinner_item, paymentTermsTypeArray);
            ...
            ArrayAdapter<String> additionalDiscountTypeArrayAdapter =
                    new ArrayAdapter<String>(CreateOrderActivity.this, R.layout.simple_spinner_item, discountTypeArr);
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (s != null && s.toString().length() != 0 && !s.equals("-") && !s.equals(".")) {
                        try {
                            ...
                            payableAmountValueTextView.setText(String.valueOf(new BigDecimal(ParseDouble(grandTotalValueTextView.getText().toString().trim()) +
            ...
            salesLedgerValueAutocompleteTextView.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (salesLedgerValueAutocompleteTextView.isPerformingCompletion()) {
                        ...
                        status = NetworkUtil.getConnectivityStatusString(CreateOrderActivity.this);
            ...
            searchPaymentLedgerValueAutocompleteTextView.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (searchPaymentLedgerValueAutocompleteTextView.isPerformingCompletion()) {
                        ...
                        status = NetworkUtil.getConnectivityStatusString(CreateOrderActivity.this);
                        if (!status.equals(getString(R.string.not_connected_to_internet))) {
                            String agId = paymentModeDataList.get(paymentModeSpinner.getSelectedItemPosition()).getAgid();
            ...
            status = NetworkUtil.getConnectivityStatusString(CreateOrderActivity.this);
            if (!status.equals(getString(R.string.not_connected_to_internet))) {
                getOrderPrefilledData(CreateOrderActivity.this);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private Intent dispatchTakePictureIntent() {
        ...
        try {
            ...
            Uri uri = FileProvider.getUriForFile(CreateOrderActivity.this,
    ...
    public boolean getPostData() {
        ...
        if (!creditRadioBtn.isChecked() && !cashCarryRadioBtn.isChecked()) {
            Toast.makeText(CreateOrderActivity.this, "Please select Order type.", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (deliveryDateTextInputEditText.getText().toString().length() == 0) {
            Toast.makeText(CreateOrderActivity.this, "Please select delivery date.", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    public void scanBarcode(int resultCode) {
        Intent intentScan = new Intent(CreateOrderActivity.this, ScannerActivity.class);
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(Call call, retrofit2.Response response) {
                    ...
                    if (apiResponse.getSuccess()) {
                        if (CreateOrderActivity.this != null) {
                        ...
                        if (CreateOrderActivity.this != null) {
                            //Logout
                            Constants.logoutWrongCredentials(CreateOrderActivity.this,
    ...
    public void openProductSearchDialog() {
        dialog = new Dialog(CreateOrderActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(CreateOrderActivity.this);
        quotationProductsAdapter = new QuotationProductsAdapter(CreateOrderActivity.this,
    ...
    public void searchProduct(String str) {
        ...
        if (AppPreferences.getIsLogin(CreateOrderActivity.this, AppUtils.ISLOGIN)) {
            userId = AppPreferences.getUserId(CreateOrderActivity.this, AppUtils.USER_ID);
            accessToken = AppPreferences.getAccessToken(CreateOrderActivity.this, AppUtils.ACCESS_TOKEN);
            ApiClient.BASE_URL = AppPreferences.getLastDomain(CreateOrderActivity.this, AppUtils.DOMAIN);
        }
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    ...
                    //Deleted User
                            ...
                            apiResponse.getSuccessCode().equals(Constants.INVALID_ACCESSTOKEN)) {
                        //Logout
                        Constants.logoutWrongCredentials(CreateOrderActivity.this, apiResponse.getMessage());
                    } else {
                        Toast.makeText(CreateOrderActivity.this, apiResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                if (CreateOrderActivity.this != null) {
                    Toast.makeText(CreateOrderActivity.this, getString(R.string.connect_server_failed), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void searchedProductDetails(String id, final String sourceType) {
        ...
        if (sourceType != null && sourceType.equals("scan")) {
            ...
            call = apiService.getSearchedProductsDetails(version, key, task, userId, accessToken, id,
                    strCuid);
        }
        Log.d("url", String.valueOf(call.request().url()));
        call.enqueue(new Callback<ApiResponse>() {
                ...
                try {
                    if (apiResponse.getSuccess()) {
                        ...
                        if (productsDialog == null || !productsDialog.isShowing()) {
                            dialogAddItems(CreateOrderActivity.this, sourceType, itemData, 0);
                        }
                    }
                    //Deleted User
                    else if (apiResponse.getSuccessCode().equals(Constants.WRONG_CREDENTIALS) ||
    ...
    private void dialogAddItems(Activity activity, final String sourceType, final ItemData itemData,
        ...
        productsDialog = new Dialog(CreateOrderActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        ...
        try {
            ...
            if (orderDealerPriceCheckBox.isChecked() || (itemData.getStrDealerFlag() != null &&
                ...
                priceEdittext.setText(new BigDecimal(Constants.roundTwoDecimals(Constants.ParseDouble(itemData.getDealerPrice())
                )).setScale(2, RoundingMode.HALF_UP).toPlainString());
            } else {
            ...
            textViewAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (quantityEdittext.getText().length() == 0) {
                        Toast.makeText(CreateOrderActivity.this, "Please enter quantity of product first", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CreateOrderActivity.this, "Please enter valid quantity", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CreateOrderActivity.this, "Please enter valid price", Toast.LENGTH_SHORT).show();
    ...
    public void editItemAndOpenDialog(int position) {
        if (productsDialog == null || !productsDialog.isShowing()) {
            dialogAddItems(CreateOrderActivity.this, "edit", itemDataArrayList.get(position), position);
        }
    }
            ...
            if (chargesList.getEctid().equals("1")) {
                if (strExtensiveTaxFlag != null && strExtensiveTaxFlag.equals("1")) {
                    if (materialCostLayout.getVisibility() == View.VISIBLE) {
                        ...
                        chargesList.setDiscountValue("" + new BigDecimal(discountValue).setScale(2, RoundingMode.HALF_UP).toPlainString());
            ...
            if (materialCostLayout.getVisibility() == View.VISIBLE) {
                chargesList2.setDiscountAmountValue(String.valueOf(new BigDecimal
                        (((ParseDouble(chargeThreeValueTextView.getText().toString().trim()))
                                * ParseDouble(discountValue)) / 100).setScale(2, RoundingMode.HALF_UP).toPlainString()));
                chargesList2.setDiscountValue("" + new BigDecimal(discountValue).setScale(2, RoundingMode.HALF_UP).toPlainString());
    ...
    public double sumTaxCharges() {
        ...
        if (taxLayout.getVisibility() == View.VISIBLE && taxChargeValueTextView.getText().toString().trim().length() != 0) {
            sum = Constants.roundTwoDecimals(ParseDouble(taxChargeValueTextView.getText().toString().trim()));
        }
        return sum;
    }
    ...
    public void setGrandTotalAndPayableAmount() {
        ...
        roundOffEdittext.setText(String.valueOf(new BigDecimal(roundOff)
                .setScale(2, RoundingMode.HALF_UP).toPlainString()));
        //roundOffValueTextView.setText(String.valueOf(roundOff));

        payableAmountValueTextView.setText(String.valueOf
                (new BigDecimal(roundTwoDecimals(roundOff +
                        ParseDouble(grandTotalValueTextView.getText().toString().trim())))
                        .setScale(2, RoundingMode.HALF_UP).toPlainString()));
    ...
    public void getOrderPrefilledData(final Activity activity) {
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    if (apiResponse.getSuccess()) {
                        ...
                        if (apiResponse.getData().getOrderFormData().getSalesTypes() != null &&
                                !apiResponse.getData().getOrderFormData().getSalesTypes().isEmpty() &&
                                !apiResponse.getData().getOrderFormData().getSalesTypes().equals("null")) {
                            for (CustomerSalesType type : apiResponse.getData().getOrderFormData().getSalesTypes()) {
                                customerSalesTypeArrayList.add(type);
                            }
                        }

                        ArrayAdapter<CustomerSalesType> salesTypeArrayAdapter =
                                new ArrayAdapter<CustomerSalesType>(CreateOrderActivity.this,
                        ...
                        if (apiResponse.getData().getOrderFormData().getPaymentModeData() != null &&
                                !apiResponse.getData().getOrderFormData().getPaymentModeData().isEmpty() &&
                                !apiResponse.getData().getOrderFormData().getPaymentModeData().equals("null")) {
                            for (PaymentModeData type : apiResponse.getData().getOrderFormData().getPaymentModeData()) {
                                paymentModeDataList.add(type);
                            }
                        }

                        ArrayAdapter<PaymentModeData> modeDataArrayAdapter =
                                new ArrayAdapter<PaymentModeData>(CreateOrderActivity.this,
                        ...
                        //TODO - Sales Ledger
                        if (apiResponse.getData().getOrderFormData().getLedgerInfo() != null &&
                                apiResponse.getData().getOrderFormData().getLedgerInfo().getName() != null) {
                            salesLedgerValueAutocompleteTextView.setText(
                                    apiResponse.getData().getOrderFormData().getLedgerInfo().getName());
                            strSalesLedgerId = apiResponse.getData().getOrderFormData().getLedgerInfo().getAlid();
                            strSalesLedgerName = apiResponse.getData().getOrderFormData().getLedgerInfo().getName();
                            disableSalesLedgerAutoComplete();
                        }
                     ...
                     /*   EmailTemplateArr emailTemplate = new EmailTemplateArr();
                        ...
                        ArrayAdapter<SmsTemplateDatum> smsTemplateArrayAdapter =
                                new ArrayAdapter<SmsTemplateDatum>(CreateOrderActivity.this, R.layout.simple_spinner_item, smsTemplateDataArrayList);
                        ...
                        ArrayAdapter<EmailTemplateArr> emailTemplateArrayAdapter =
                                new ArrayAdapter<EmailTemplateArr>(CreateOrderActivity.this, R.layout.simple_spinner_item, emailTemplateArrArrayList);
                        ...
                        if (apiResponse.getData().getExtensiveTaxRequired() != null &&
                            ...
                            /*quotationChargesListAdapter = new QuotationChargesListAdapter(activity, preChargesListArrayList,
                                    taxListArrayList, "1", CreateOrderActivity.this);
                            chargeListRecyclerView.setAdapter(quotationChargesListAdapter);
                            quotationChargesListAdapter.notifyDataSetChanged();*/
                           ...
                           /* chargesList3ArrayList.remove(0);
                            ...
                            quotationThreeChargesDropDownAdapter = new QuotationThreeChargesDropDownAdapter(CreateOrderActivity.this,
                                    chargesList3ArrayList, taxListArrayList, "1", CreateOrderActivity.this);
                            chargeListThreeRecyclerView.setAdapter(quotationThreeChargesDropDownAdapter);
                            ...
                            quotationChargesThreeSpinnerCheckAdapter = new QuotationChargesThreeSpinnerCheckAdapter(CreateOrderActivity.this, R.layout.item,
                                    chargesList3ArrayList, CreateOrderActivity.this);
    ...
    private void pretaxChargesDialog(int position) {
        ...
        try {
            ...
            if (chargesList.getDiscountAmountValue() != null && !chargesList.getDiscountAmountValue().isEmpty()) {
                chargeValueTextView.setText("" + new BigDecimal(
                        Constants.roundTwoDecimals(Constants.ParseDouble(chargesList.getDiscountAmountValue())))
                        .setScale(2, RoundingMode.HALF_UP).toPlainString());
            }
            ...
            ArrayAdapter<TaxList> taxListArrayAdapter =
                    new ArrayAdapter<TaxList>(CreateOrderActivity.this, R.layout.simple_spinner_item, taxListArrayList);
            taxListArrayAdapter.setDropDownViewResource(R.layout.spinner_common_item);
            ...
            edittext.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (chargeTypeSpinner.getSelectedItemPosition() == 0) {
                        if (chargesList.getEctid() != null && chargesList.getEctid().equals("2")) {
                            chargeValueTextView.setText("" + new BigDecimal(Constants.roundTwoDecimals(Constants.ParseDouble(
            ...
            chargeTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if (chargesList.getEctid() != null && chargesList.getEctid().equals("2") &&
                        ...
                        if (chargesList.getEctid() != null && chargesList.getEctid().equals("2")) {
                            chargeValueTextView.setText("" + new BigDecimal(Constants.roundTwoDecimals(Constants.
                                    ParseDouble(edittext.getText().toString().trim())))
                                    .setScale(2, RoundingMode.HALF_UP).toPlainString());
                            chargesList.setDiscountValue("" + new BigDecimal(Constants.roundTwoDecimals(Constants.
                                    ParseDouble(edittext.getText().toString())))
                                    .setScale(2, RoundingMode.HALF_UP).toPlainString());
                            chargesList.setDiscountAmountValue("" + new BigDecimal(Constants.roundTwoDecimals(Constants.
                                    ParseDouble(chargeValueTextView.getText().toString().trim())))
                                    .setScale(2, RoundingMode.HALF_UP).toPlainString());
                        } else {
                            double newValue = (((ParseDouble(materialCostValueTextView.getText().toString()) -
                                    ParseDouble(additionalDiscountValueTextView.getText().toString().replace("-", ""))) +
            ...
            saveTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    updatePreChargesList(chargesList, "" + new BigDecimal(Constants.roundTwoDecimals(Constants.
                            ParseDouble(edittext.getText().toString().trim())))
                            .setScale(2, RoundingMode.HALF_UP).toPlainString(), position);
    ...
    private void searchSalesLedger(String searchText, String agId, String type) {
        ...
        if (AppPreferences.getBoolean(CreateOrderActivity.this, AppUtils.ISLOGIN)) {
            userId = AppPreferences.getUserId(CreateOrderActivity.this, AppUtils.USER_ID);
            accessToken = AppPreferences.getAccessToken(CreateOrderActivity.this, AppUtils.ACCESS_TOKEN);
            ApiClient.BASE_URL = AppPreferences.getLastDomain(CreateOrderActivity.this, AppUtils.DOMAIN);
        }
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    if (apiResponse.getSuccess()) {
                        ...
                        ledgersArrayAdapter =
                                new ArrayAdapter<LedgerSearchData>(CreateOrderActivity.this,
                    ...
                    try {
                        if (apiResponse.getSuccess()) {
                            ...
                            //Deleted User
                                ...
                                //Logout
                                if (CreateOrderActivity.this != null) {
                                    Constants.logoutWrongCredentials(CreateOrderActivity.this, message);
                                }
                            } else {
                                if (CreateOrderActivity.this != null) {
                        ...
                        if (apiResponse.getSuccess()) {
                            ...
                            if (status) {
                                if (CreateOrderActivity.this != null) {
                                    ...
                                    Intent resultIntent = new Intent(CreateOrderActivity.this, DrawerActivity.class);
